...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBarWeb = (ProgressBar) findViewById(R.id.progressBarId);
        progressDialog = new ProgressDialog(this);
        progressDialog.setMessage("Loading Please Wait");

        btnNoInternetConnection = (Button) findViewById(R.id.btnNoInternetConnection);
        relativeLayout = (RelativeLayout) findViewById(R.id.relativeLayoutConnectionId);
        ...
        // Using WebViewClient so that no external browser need
